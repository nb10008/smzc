...
public:
	...
	void SetFileFilter(const char* szFilter)	{	m_szFileFilter=szFilter;}
	static COLORREF Str2Color(const char* szRGBStr);
...
public:
	...
	void UpdateVal(const char* szName,float& v,int index,bool bSave);
	void UpdateVal(const char* szName,int& v,int index,bool bSave);
	void UpdateVal(const char* szName,BYTE& v,int index,bool bSave);
	void UpdateVal(const char* szName,char* szBuf,int bufSize,int index,bool bSave,bool bFileName);
	void UpdateVal(const char* szName,bool& v,int index,bool bSave);
	void UpdateVal(const char* szName,Color4f& v,int index,bool bSave);//RGB only,not alpha
