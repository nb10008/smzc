================================================================================
    MICROSOFT 基础类库： EffectAttacher 项目概述
===============================================================================

应用程序向导已为您创建了此 EffectAttacher 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 EffectAttacher 应用程序的每个文件的内容摘要。
...
EffectAttacher.h
    ...
    CEffectAttacherApp 应用程序类。

EffectAttacher.cpp
    这是包含应用程序
    类 CEffectAttacherApp 的主应用程序源文件。
...
res\EffectAttacher.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 EffectAttacher.rc 中。

res\EffectAttacher.rc2
    此文件包含不由 Microsoft 
...
EffectAttacherDoc.h、EffectAttacherDoc.cpp - 文档
    这些文件包含 CEffectAttacherDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CEffectAttacherDoc::Serialize）。
EffectAttacherView.h、EffectAttacherView.cpp - 文档视图
    这些文件包含 CEffectAttacherView 类。
    CEffectAttacherView 对象用于查看 CEffectAttacherDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 EffectAttacher.pch 的预编译头文件 (PCH)
