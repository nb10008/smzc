================================================================================
    MICROSOFT 基础类库： Cool3DView 项目概述
===============================================================================

应用程序向导已为您创建了此 Cool3DView 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 Cool3DView 应用程序的每个文件的内容摘要。
...
Cool3DView.h
    ...
    CCool3DViewApp 应用程序类。

Cool3DView.cpp
    这是包含应用程序
    类 CCool3DViewApp 的主应用程序源文件。
...
Cool3DViewDoc.h、Cool3DViewDoc.cpp - 文档
    这些文件包含 CCool3DViewDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CCool3DViewDoc::Serialize）。
Cool3DViewWnd.h、Cool3DViewWnd.cpp - 文档视图
    这些文件包含 CCool3DViewWnd 类。
    CCool3DViewWnd 对象用于查看 CCool3DViewDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 Cool3DView.pch 的预编译头文件 (PCH)
