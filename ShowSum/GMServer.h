...
public:
	...
	DWORD		HandleAllServerDynInfo(tagNetCmd* pMsg, DWORD);

	//void		PrintInfo(FLOAT fRate, BOOL bNewest, wstring& szSectionName, wstring& szWorldName, INT& nOnline);
	...
	TMap<INT, Section*>&	GetSectionMap()			{ return m_mapSection; }
