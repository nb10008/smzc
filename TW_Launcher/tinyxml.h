...
public:
	...
	*/
	...
	bool LoadFile( const TCHAR * filename, XmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	...
	*/
	...
	bool LoadFile( const tstring& filename, XmlEncoding encoding = TIXML_DEFAULT_ENCODING )			///< STL std::string version.
	{
