...
//FPlan 1.4.0
	...
	bRet = TMethod_Loong_PagingServerMerge(TypeArea,m_clsMergeLogicCtrl);
	if(bRet == FALSE)
	{	
...
//FPlan1.2.1
	...
	bRet = TMethod_Loong_PagingServerMerge(TypeFabaoNirVanaData,m_clsMergeLogicCtrl);
	if(bRet == FALSE)
	{	
...
//2.0.0-新增表
	...
	bRet = TMethod_Loong_PagingServerMerge(TypeFabao,m_clsMergeLogicCtrl);
	if(bRet == FALSE)
	{	
...
//1.3.2-新增表
	...
	bRet = TMethod_Loong_PagingServerMergeSpec(TypeShortCutBar,m_clsMergeLogicCtrl);
	if(bRet == FALSE)
	{	
...
//---------------------------------------------------------------------------------------
	...
	bRet = TMethod_Loong_PagingServerMerge(TypeSkill,m_clsMergeLogicCtrl);
	if(bRet == FALSE)
	{
...
//---------------------------------------------------------------------------------------
	...
	bRet = TMethod_Loong_PagingServerMerge(TypeVisitingCard,m_clsMergeLogicCtrl);
	if(bRet == FALSE)
	{
...
//---------------------------------------------------------------------------------------
	...
	bRet = TMethod_Loong_PagingServerMerge(TypeSoulCrystal,m_clsMergeLogicCtrl);
	if(bRet == FALSE)
	{
	...
	// F-Plan 1.5.12 新增表 UseKeyCode_roleID
	g_clsOutput.Output(_T("开始合并--UseKeyCode_roleID!\r\n"));
	tagTWrap_Loong_UseKeyCode *TypeUseKeyCode = NULL;
	bRet = TMethod_Loong_ServerMerge(TypeUseKeyCode,m_clsMergeLogicCtrl);
	if(bRet == FALSE)
	{	
		g_clsOutput.Output(_T("合并失败--UseKeyCode_roleID!\r\n"));
		return FALSE;
	}
	g_clsOutput.Output(_T("合并成功--UseKeyCode_roleID!\r\n"));

	// F-Plan 1.6.0 新增holyman和holyequip
	//holyman
	g_clsOutput.Output(_T("开始合并--holyman!\r\n"));
	tagTWrap_Loong_Holy *TypeHoly = NULL;
	bRet = TMethod_Loong_PagingServerMerge(TypeHoly,m_clsMergeLogicCtrl);
	if(bRet == FALSE)
	{	
		g_clsOutput.Output(_T("合并失败--holyman!\r\n"));
		return FALSE;
	}
	g_clsOutput.Output(_T("合并成功--holyman!\r\n"));

	//holyequip
	g_clsOutput.Output(_T("开始合并--holyequip!\r\n"));
	tagTWrap_Loong_HolyEquip *TypeHolyEquip = NULL;
	bRet = TMethod_Loong_PagingServerMerge(TypeHolyEquip,m_clsMergeLogicCtrl);
	if(bRet == FALSE)
	{	
		g_clsOutput.Output(_T("合并失败--holyequip!\r\n"));
		return FALSE;
	}
	g_clsOutput.Output(_T("合并成功--holyequip!\r\n"));	
...
//---------------------------------------------------------------------------------------
	...
	{
		if( !sLoongBeton.DeleteRareareaData(EM_DB_TAR) )
		{
