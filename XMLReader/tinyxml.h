...
public:
	...
	bool LoadFile( IFS *pFS, const TCHAR * filename, XmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	...
	*/
	...
	bool LoadFile( IFS *pFS, const tstring& filename, XmlEncoding encoding = TIXML_DEFAULT_ENCODING )			///< STL std::string version.
	{
		return LoadFile( pFS, filename.c_str(), encoding );
	}
