...
function I4800200_GiftBag(MapID, InstanceID, TypeID, TargetID)
	...
	role.AddRoleItem(MapID, InstanceID, TargetID, 3060001,20, -1, 8, 420)
end
...
function I4800201_GiftBag(MapID, InstanceID, TypeID, TargetID)
	--玩家ID， 生成物品TypeID，数量，品质，生成模式，log用网络消息枚举
	role.AddRoleItem(MapID, InstanceID, TargetID, 3070056,10, -1, 8, 420)
	role.AddRoleItem(MapID, InstanceID, TargetID, 3050005,4, -1, 8, 420)
	role.AddRoleItem(MapID, InstanceID, TargetID, 3050001,20, -1, 8, 420)
	role.AddRoleItem(MapID, InstanceID, TargetID, 3050031,1, -1, 8, 420)
	role.AddRoleItem(MapID, InstanceID, TargetID, 3030126,2, -1, 8, 420)
...
function I4800204_GiftBag(MapID, InstanceID, TypeID, TargetID)
	--玩家ID， 生成物品TypeID，数量，品质，生成模式，log用网络消息枚举
	role.AddRoleItem(MapID, InstanceID, TargetID, 3070056,10, -1, 8, 420)
	role.AddRoleItem(MapID, InstanceID, TargetID, 3050062,1, -1, 8, 420)
	role.AddRoleItem(MapID, InstanceID, TargetID, 3050063,1, -1, 8, 420)
	role.AddRoleItem(MapID, InstanceID, TargetID, 3050064,1, -1, 8, 420)
...
function I4800207_GiftBag(MapID, InstanceID, TypeID, TargetID)
	...
	role.AddRoleItem(MapID, InstanceID, TargetID, 3050016,8, -1, 8, 420)
...
function I4800208_GiftBag(MapID, InstanceID, TypeID, TargetID)
	--玩家ID， 生成物品TypeID，数量，品质，生成模式，log用网络消息枚举
	role.AddRoleItem(MapID, InstanceID, TargetID, 3070056,30, -1, 8, 420)
	role.AddRoleItem(MapID, InstanceID, TargetID, 3050062,2, -1, 8, 420)
	role.AddRoleItem(MapID, InstanceID, TargetID, 3050063,2, -1, 8, 420)
	role.AddRoleItem(MapID, InstanceID, TargetID, 3050064,2, -1, 8, 420)
...
function I4800209_GiftBag(MapID, InstanceID, TypeID, TargetID)
	--玩家ID， 生成物品TypeID，数量，品质，生成模式，log用网络消息枚举
	role.AddRoleItem(MapID, InstanceID, TargetID, 3070056,30, -1, 8, 420)
	role.AddRoleItem(MapID, InstanceID, TargetID, 3030135,2, -1, 8, 420)
