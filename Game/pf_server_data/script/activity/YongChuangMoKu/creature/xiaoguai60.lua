...
function xiaoguai60_OnDie(MapID, InstanceID, TargetID, TargetTypeID, RoleID)
	...
	if freshboss == 0 then
		...
		if poss > 97 then
			...
			if boss == 1 then
				...
				map.MapCreateCreature(MapID, InstanceID, 2054029+boss , x, y, z)
			elseif boss == 2 then
				local x,y,z = unit.GetPosition(MapID, InstanceID, TargetID)
				map.MapCreateCreature(MapID, InstanceID, 2054029+boss, x, y, z)
			elseif boss == 3 then
...
aux.RegisterCreatureEvent(2051025, 4, "xiaoguai60_OnDie")
aux.RegisterCreatureEvent(2051026, 4, "xiaoguai60_OnDie")
aux.RegisterCreatureEvent(2051027, 4, "xiaoguai60_OnDie")
aux.RegisterCreatureEvent(2051028, 4, "xiaoguai60_OnDie")
