...
function xiaoguai70_OnDie(MapID, InstanceID, TargetID, TargetTypeID, RoleID)
	...
	if freshboss == 0 then
		...
		if poss > 97 then
			...
			if boss == 1 then
				...
				map.MapCreateCreature(MapID, InstanceID, 2054081+boss , x, y, z)
			elseif boss == 2 then
				local x,y,z = unit.GetPosition(MapID, InstanceID, TargetID)
				map.MapCreateCreature(MapID, InstanceID, 2054081+boss, x, y, z)
			elseif boss == 3 then
...
aux.RegisterCreatureEvent(2051033, 4, "xiaoguai70_OnDie")
aux.RegisterCreatureEvent(2051034, 4, "xiaoguai70_OnDie")
aux.RegisterCreatureEvent(2051035, 4, "xiaoguai70_OnDie")
aux.RegisterCreatureEvent(2051036, 4, "xiaoguai70_OnDie")
