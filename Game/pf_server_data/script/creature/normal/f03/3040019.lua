...
function c3040019_OnEnterCombat(MapID, InstanceID, CreatureID)
...
aux.RegisterCreatureEvent(3040019, 2, "c3040019_OnEnterCombat")

function c3040019_OnDie(MapID, InstanceID, TargetID, TargetTypeID, RoleID)
...
aux.RegisterCreatureEvent(3040019, 4, "c3040019_OnDie")
