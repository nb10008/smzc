...
local function OnTalk()
	...
	Quest.NPCTalk(0,0,"<font=龙字体,0,19,20><color=0xfffcf157>军需官艾拉：<color=0xffffffff><font=龙字体,0,17,20>\\n现在选择武器并不会影响以后就职，所以不要过于纠结选择哪种武器。");
...
local function OnAcceptQuestTalk(id,step)--如果删除任务，可重新手动接取
        if( id == 20003)then
                Quest.CloseNPCTalk();
		Quest.AcceptQuestTalk(20003,"<font=龙字体,0,19,20><color=0xfffcf157>军需官艾拉：<color=0xffffffff><font=龙字体,0,17,20>\\n现在就开始进行战神候补的试炼吧！只有通过了这里的试炼，你才有资格进入<color=0xffababff>斗战天城<color=0xffffffff>，成为一名真正的天界勇士。\\n    先试试清理附近<color=0xffffe289>小魔灵<color=0xffffffff>，然后向<color=0xff00ddbb>天隐<color=0xffffffff>汇报。");
        end
end
