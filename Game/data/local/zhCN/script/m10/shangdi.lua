...
local function OnTalk()
	...
	Quest.NPCTalk(0,0,"<font=龙字体,0,19,20><color=0xfffcf157>殇帝：<color=0xffffffff>\\n升级后可对技能进行升级加点，技能的快捷键为<color=0xffff00ff>K<color=0xffffffff>。");
...
local function OnAcceptQuestTalk(id,step)--如果删除任务，可重新手动接取
        if( id == 20004)then
                Quest.CloseNPCTalk();
		Quest.AcceptQuestTalk(20004,"<font=龙字体,0,19,20><color=0xfffcf157>殇帝：<color=0xffffffff>\\n    目前你只可学习和升级新手技能，达到<color=0xff00ddfe>20<color=0xffffffff>级就职以后可学习<color=0xff80ff00>职业技能<color=0xffffffff>。\\n接下来找到<color=0xff00ddbb>神教官艾斯<color=0xffffffff>继续进行教学。");
        end
end
