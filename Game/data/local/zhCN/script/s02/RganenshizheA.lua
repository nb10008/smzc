...
local function OnAcceptQuestTalk(id,step)--如果删除任务，可重新手动接取
	if( id == 30883)then
  	--  Quest.CloseNPCTalk();
		Quest.AcceptQuestTalk(30883,"<font=龙字体,0,19,20><color=0xfffcf157>龙神使者：<color=0xffffffff>\\n    现在是第一次经验领取时间，赶紧领取吧，20：50之后就进入下个经验领取时间了！");
	end
end
...
local function OnCompleteQuestTalk(id,step)
	if( id == 30883)then
  	--  Quest.CloseNPCTalk();
		Quest.CompleteQuestTalk(30883,"<font=龙字体,0,19,20><color=0xfffcf157>龙神使者：<color=0xffffffff>\\n    好了，经验给你了，记得感谢我！");
	end
end
