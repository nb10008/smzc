...
function xiaoguai85_OnDie(MapID, InstanceID, TargetID, TargetTypeID, RoleID)
	...
	if freshboss == 0 then
		...
		if poss > 97 then
			...
			if boss == 1 then
				...
				map.MapCreateCreature(MapID, InstanceID, 2054159+boss , x, y, z)
			elseif boss == 2 then
				local x,y,z = unit.GetPosition(MapID, InstanceID, TargetID)
				map.MapCreateCreature(MapID, InstanceID, 2054159+boss, x, y, z)
			elseif boss == 3 then
...
aux.RegisterCreatureEvent(2051045, 4, "xiaoguai85_OnDie")
aux.RegisterCreatureEvent(2051046, 4, "xiaoguai85_OnDie")
aux.RegisterCreatureEvent(2051047, 4, "xiaoguai85_OnDie")
aux.RegisterCreatureEvent(2051048, 4, "xiaoguai85_OnDie")
