...
function c3040108_OnEnterCombat(MapID, InstanceID, CreatureID)
...
aux.RegisterCreatureEvent(3040108, 2, "c3040108_OnEnterCombat")
...
function c3040108_OnDie(MapID, InstanceID, TargetID, TargetTypeID, RoleID)
	...
	local bset = map.GetMapScriptData(MapID, InstanceID, 1,16)
	if bset == 1 then
...
aux.RegisterCreatureEvent(3040108, 4, "c3040108_OnDie")
