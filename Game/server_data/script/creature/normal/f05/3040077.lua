...
function c3040077_OnEnterCombat(MapID, InstanceID, CreatureID)
...
aux.RegisterCreatureEvent(3040077, 2, "c3040077_OnEnterCombat")
...
function c3040077_OnDie(MapID, InstanceID, TargetID, TargetTypeID, RoleID)

	cre.MonsterSay(MapID, InstanceID, TargetID, 10064)
	local a = math.random(1,100)
	if a>50 then
		local x,y,z=unit.GetPosition(MapID, InstanceID,TargetID)
		map.MapCreateCreature(MapID, InstanceID, 3040092, x, y, z)
		map.MapCreateCreature(MapID, InstanceID, 3040092, x, y, z)
		map.MapCreateCreature(MapID, InstanceID, 3040092, x, y, z)
	end
	...
	if bossdeath_1 == 1 and bossdeath_2 == 1 and bossdeath_4 == 1 then
...
aux.RegisterCreatureEvent(3040077, 4, "c3040077_OnDie")
