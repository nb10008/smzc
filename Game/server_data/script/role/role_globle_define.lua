...
RoleDataType["Tianxuanzhe_time"]							= 116   --天选者时间
RoleDataType["jiangpaijifen_today"]						= 117  --当天奥运活动奖牌积分
RoleDataType["jiangpaijifen_all"]						= 118  --整体奥运活动奖牌积分
RoleDataType["jiangpaijifen_time"]						= 119  --奥运活动奖牌积分日期
RoleDataType["jiangpaijifen_got"]						= 120  --今天是否已领取过奥运每日奖励
RoleDataType["jiangpaijifen_gotall"]						= 121  --是否已领取过整体奥运奖励
RoleDataType["aoyunpaobu_time"]						= 122  --跑步项目时间
RoleDataType["aoyunpaobu_baoming"]						= 123  --跑步项目是否已报名
RoleDataType["aoyunpaobu_got"]						= 124  --跑步项目奖励是否已领取
RoleDataType["aoyunpaobu_shiduan"]						= 125  --起点处记录跑步项目时段
RoleDataType["aoyunyouyong_time"]						= 126  --游泳项目时间
RoleDataType["aoyunyouyong_baoming"]						= 127  --游泳项目是否已报名
RoleDataType["aoyunyouyong_got"]						= 128  --游泳项目奖励是否已领取
RoleDataType["aoyunyouyong_shiduan"]						= 129  --起点处记录游泳项目时段
RoleDataType["zuoqirenwu"]						= 130  --坐骑任务记录
RoleDataType["zhongxiaye"]						= 131  --仲夏夜记录
RoleDataType["shenmozaowu"]						= 132  --神魔造物任务
RoleDataType["aoyunjinjichang_time"]						= 133  --竞技场项目时间
RoleDataType["aoyunjinjichang_baoming"]						= 134  --竞技场项目是否已报名
RoleDataType["aoyunjinjichang_got"]						= 135  --竞技场项目奖励是否已领取
RoleDataType["aoyunjinjichang_shiduan"]						= 136  --起点处记录竞技场项目时段
RoleDataType["aoyunjinjichang_jifen"]						= 137  --记录竞技场项目积分
RoleDataType["shenglingyangcheng"]						= 138  --记录竞技场项目积分
