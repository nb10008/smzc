...
--Game.exe
		...
		PeGamexy.strPeName 					  		= "Client.exe";
		PeGamexy.u32LoadBase 						= 0x00000000;
		PeGamexy.u32CodeOffset				  		= 0x00001000;
...
--Apex2
		...
		OwnApex2.u32CodeSize 						= 0x00082e82;
		OwnApex2.u32RelocOffset						= 0x000e7000;
...
--Apex2CRC
		...
		Crc32Result2.u32Crc32 							= 0x66fe05d2;
