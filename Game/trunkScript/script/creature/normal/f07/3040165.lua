...
function c3040165_OnEnterCombat(MapID, InstanceID, CreatureID)

	--cre.MonsterSay(MapID, InstanceID, CreatureID, 10063)
	
end

aux.RegisterCreatureEvent(3040165, 2, "c3040165_OnEnterCombat")
...
function c3040165_OnDie(MapID, InstanceID, TargetID, TargetTypeID, RoleID)

	--cre.MonsterSay(MapID, InstanceID, TargetID, 10064)
	
	

	local fenshenisdead_01 = map.GetMapScriptData(MapID,InstanceID,1,7)
...
aux.RegisterCreatureEvent(3040165, 4, "c3040165_OnDie")
