...
function c3040166_OnEnterCombat(MapID, InstanceID, CreatureID)

	--cre.MonsterSay(MapID, InstanceID, CreatureID, 10063)
	
end

aux.RegisterCreatureEvent(3040166, 2, "c3040166_OnEnterCombat")
...
function c3040166_OnDie(MapID, InstanceID, TargetID, TargetTypeID, RoleID)
	...
	local fenshenisdead_02 = map.GetMapScriptData(MapID,InstanceID,1,7)
...
aux.RegisterCreatureEvent(3040166, 4, "c3040166_OnDie")
