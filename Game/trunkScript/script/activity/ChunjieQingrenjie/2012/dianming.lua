...
function dianmingNor(hour,min)
	local giftNormal={1,2,3,4,5}    --平常奖励
	local NormalId = {4830095,4830096,4830097,4830098,4830099}
    local length=0
			...
			if(num >= 1) then
				if RoleID == GetGiftRoleID[i][1] then
					if GetGiftRoleID[i][3] == 1 then
						inGift = false
						local x = 0 
						if GetGiftRoleID[i][2] == 4830095 or GetGiftRoleID[i][2] == 4830097 or GetGiftRoleID[i][2] == 3500204 then
							x = 1
						elseif GetGiftRoleID[i][2] == 4830096 then
							x = 3
						elseif GetGiftRoleID[i][2] == 4830098 then
							x = 5
						elseif GetGiftRoleID[i][2] == 4830099 then
							x = 2
						end
						if role.GetBagFreeSize(RoleID) < 1 then
							...
							role.AddRoleItem(MapID, InstanceID, RoleID, GetGiftRoleID[i][2], x, -1, 8, 35)
							GetGiftRoleID[i][3] = 0
							temp =true
							bool = false
						end
