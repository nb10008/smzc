...
--mapscriptdata[10] 记录副本里是否刷过boss




function xiaoguai55_OnDie(MapID, InstanceID, TargetID, TargetTypeID, RoleID)
	...
	if freshboss == 0 then
		...
		if poss > 97 then
			...
			if boss == 1 then
				...
				map.MapCreateCreature(MapID, InstanceID, 2054004+boss , x, y, z)
			elseif boss == 2 then
				local x,y,z = unit.GetPosition(MapID, InstanceID, TargetID)
				map.MapCreateCreature(MapID, InstanceID, 2054004+boss, x, y, z)
			elseif boss == 3 then
...
aux.RegisterCreatureEvent(2051021, 4, "xiaoguai55_OnDie")
aux.RegisterCreatureEvent(2051022, 4, "xiaoguai55_OnDie")
aux.RegisterCreatureEvent(2051023, 4, "xiaoguai55_OnDie")
aux.RegisterCreatureEvent(2051024, 4, "xiaoguai55_OnDie")
