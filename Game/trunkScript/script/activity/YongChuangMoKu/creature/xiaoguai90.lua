	...
	if freshboss == 0 then
		...
		if poss > 97 then
			...
			if boss == 1 then
				...
				map.MapCreateCreature(MapID, InstanceID, 2054185+boss , x, y, z)
			elseif boss == 2 then
				local x,y,z = unit.GetPosition(MapID, InstanceID, TargetID)
				map.MapCreateCreature(MapID, InstanceID, 2054185+boss, x, y, z)
			elseif boss == 3 then
...
aux.RegisterCreatureEvent(2051049, 4, "xiaoguai90_OnDie")
aux.RegisterCreatureEvent(2051050, 4, "xiaoguai90_OnDie")
aux.RegisterCreatureEvent(2051051, 4, "xiaoguai90_OnDie")
aux.RegisterCreatureEvent(2051052, 4, "xiaoguai90_OnDie")
