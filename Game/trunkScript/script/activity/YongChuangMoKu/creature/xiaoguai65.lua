...
function xiaoguai65_OnDie(MapID, InstanceID, TargetID, TargetTypeID, RoleID)
	...
	if freshboss == 0 then
		...
		if poss > 97 then
			...
			if boss == 1 then
				...
				map.MapCreateCreature(MapID, InstanceID, 2054055+boss , x, y, z)
			elseif boss == 2 then
				local x,y,z = unit.GetPosition(MapID, InstanceID, TargetID)
				map.MapCreateCreature(MapID, InstanceID, 2054055+boss, x, y, z)
			elseif boss == 3 then
...
aux.RegisterCreatureEvent(2051029, 4, "xiaoguai65_OnDie")
aux.RegisterCreatureEvent(2051030, 4, "xiaoguai65_OnDie")
aux.RegisterCreatureEvent(2051031, 4, "xiaoguai65_OnDie")
aux.RegisterCreatureEvent(2051032, 4, "xiaoguai65_OnDie")
