...
function q30301_OnQuestInit(MapID, InstanceID, QuestID, RoleID, NPCID)
	...
	MoKu_reward[60] = {expe=188527,gold=22584,item=3500201}
	MoKu_reward[65] = {expe=244755,gold=23615,item=3500201}
	MoKu_reward[70] = {expe=337365,gold=29700,item=3500201}
	MoKu_reward[75] = {expe=443205,gold=30937,item=3500201}
	MoKu_reward[80] = {expe=573300,gold=35750,item=3500202}
	MoKu_reward[85] = {expe=711112,gold=37125,item=3500202}
	MoKu_reward[90] = {expe=867667,gold=47953,item=3500202}
	MoKu_reward[95] = {expe=1042965,gold=49500,item=3500202}
	MoKu_reward[100] = {expe=1042965,gold=80000,item=3500202}
	...
	local Quest_30301 = {}
	if level >=60 then
		local ItemID = MoKu_reward[level].item
		if ItemID == 3500201 then
			shuliang = 2
		else
			shuliang = 1
		end
		Quest_30301[1]={TargetType=QuestTargetType["Kill"], TargetID1=bossid, Num1=1,MsgID=14001,RewMoney=gold, RewXP=expe, RewItemID1=ItemID,value1=shuliang}
	else
