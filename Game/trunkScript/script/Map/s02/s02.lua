...
function s02_OnInit(MapID,InstanceID,CreatureID,CreatureTypeID)
	...
	if xinkaifuhuodong == 1 then
		if tianshihuhaha == 0 then
			tianshihuhaha = map.MapCreateColCreature(3424073512, -1, 6040056, 580, 23510, 870, 1, "")
		end
	end
	if huancaishangren == 1 then
		map.MapCreateColCreature(MapID, InstanceID, 6040052,656,31176,923, 1, "")
	end
