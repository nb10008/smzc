...
应用程序向导已为您创建了此 WorldEditor 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 WorldEditor 应用程序的每个文件的内容摘要。
...
WorldEditor.h
    ...
    CWorldEditorApp 应用程序类。

WorldEditor.cpp
    这是包含应用程序
    类 CWorldEditorApp 的主应用程序源文件。
...
res\Toolbar.bmp
    ...
    更新 WorldEditor.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 WorldEditor.pch 的预编译头文件 (PCH)
