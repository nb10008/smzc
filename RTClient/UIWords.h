...
#define w_UpdateGodBid			wxT("Update GodBid:")
#define w_UpdateGodBidOK		wxT("Update")
#define	w_NoAuthUpdataGodbid	wxT("You don't have privilege to update Godbid.")
#define w_ConfirmUpdateGodbid	wxT("Confirm to update Godbid");
#define	w_AskForUpdateGodbid	wxT("Are you sure to update Godbid of selected worlds?")

#define w_UpdateZaDan			wxT("EggRate:")
#define w_UpdateZaDanOK			wxT("Update")
#define	w_NoAuthUpdataZaDan		wxT("You don't have privilege to do this.")
#define w_ConfirmUpdateZaDan	wxT("Confirm to update Egg Rate");
#define	w_AskForUpdateZaDan		wxT("Are you sure to update Egg Rate of selected worlds?")

#define w_ReloadItemNeedLog			wxT("Reload item_needlog")
#define w_ReloadItemNeedLogOK		wxT("Reload")
#define	w_NoAuthReloadItemNeedLog	wxT("You don't have privilege to do this.")
#define w_ConfirmReloadItemNeedLog	wxT("Confirm to reload item_needlog");
#define	w_AskForReloadItemNeedLog	wxT("Are you sure to reload item_needlog of selected worlds?")