...
public:
	...
	void SendUpdateGodbidMessage(DWORD section_id, DWORD world_id);
	void SendUpdateZaDanMessage(DWORD section_id, DWORD world_id);
	void SendReloadItemNeedLogMessage(DWORD section_id, DWORD world_id);
