...
CmdTable::CmdTable()
{
	...
	_sntprintf( szBuff, X_SHORT_STRING, _T("Disable RtService"));
	_sntprintf( szCmd, X_LONG_STRING, _T("sc stop Local_RtService"));
	m_mapCmdIndex.insert(std::pair<INT, LPCTSTR>(3, szBuff));
	m_mapCmd.insert(std::pair<LPCTSTR, LPCTSTR>(szBuff, szCmd));
	...
	_sntprintf( szBuff, X_SHORT_STRING, _T("ipsec only test"));
	_sntprintf( szCmd, X_LONG_STRING, _T("netsh ipsec static set policy name=\"only test\" assign=y"));
	m_mapCmdIndex.insert(std::pair<INT, LPCTSTR>(4, szBuff));
	m_mapCmd.insert(std::pair<LPCTSTR, LPCTSTR>(szBuff, szCmd));
	...
	_sntprintf( szBuff, X_SHORT_STRING, _T("ipsec word"));
	_sntprintf( szCmd, X_LONG_STRING, _T("netsh ipsec static set policy name=\"word\" assign=y"));
	m_mapCmdIndex.insert(std::pair<INT, LPCTSTR>(5, szBuff));
	m_mapCmd.insert(std::pair<LPCTSTR, LPCTSTR>(szBuff, szCmd));
