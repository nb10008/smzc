...
void MyFrame::ShowPage(bool bShow_1, bool bShow_2, bool bShow_3, bool bShow_4, bool bShow_5, bool bShow_6)
{
	if (book_ == NULL)
		return;
	...
	if (pPage != NULL)
	{
		pPage->ShowButtons(bShow_1,bShow_2,bShow_3,bShow_4, bShow_5,bShow_6);
	}
}