...
#define CACHESIZE_GEFORCE3   24
	...
	struct F3D_MAX_API PrimitiveGroup
	{
		PrimType type;
	...
	//
	F3D_MAX_API void EnableRestart(const unsigned int restartVal);
	...
	//
	F3D_MAX_API void DisableRestart();
	...
	// Default value: 16
	//
	F3D_MAX_API void SetCacheSize(const unsigned int cacheSize);
	...
	// Default value: true
	//
	F3D_MAX_API void SetStitchStrips(const bool bStitchStrips);
	...
	// Default value: 0
	//
	F3D_MAX_API void SetMinStripSize(const unsigned int minSize);
	...
	// Default value: false
	//
	F3D_MAX_API void SetListsOnly(const bool bListsOnly);
	...
	//
	F3D_MAX_API bool GenerateStrips(const unsigned short* in_indices, const unsigned int in_numIndices,
	...
	//
	F3D_MAX_API void RemapIndices(const PrimitiveGroup* in_primGroups, const unsigned short numGroups, 
