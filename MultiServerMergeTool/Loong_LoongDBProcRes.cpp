...
VOID CLoongLoongDBCtrl::ProcResQueryFabao(OUT LPVOID &pData, Beton::QueryResult *pRes)
{
	...
	do{
		...
		// 
		p->stOthers.byDamageUpgradeTimes		= (*pRes)[28].GetInt();
		p->stOthers.byResistanceUpgradeTimes	= (*pRes)[29].GetInt();
...
VOID CLoongLoongDBCtrl::ProcResQueryFabaoNirVanaData(OUT LPVOID &pData, Beton::QueryResult *pRes)
{
	...
	do{
		...
		p->data.byDamageUpgradeTimes		= (*pRes)[12].GetInt();
		p->data.byResistanceUpgradeTimes	= (*pRes)[13].GetInt();
