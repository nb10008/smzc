...
public:
	...
	DWORD OnNGMTS_AddFilterWords( tagNetCmd* pMsg );
	DWORD OnNGMTS_DelFilterWords( tagNetCmd* pMsg );
	DWORD OnNGMTS_GuildGodMiracle(tagNetCmd* pMsg);
	DWORD OnNGMTS_ClearSafeCode( tagNetCmd* pMsg );
	DWORD OnNGMTS_CloseGuard( tagNetCmd* pMsg );
