...
DWORD UserFrame::OnSysMgrPageEvent( tagUserEvent* pGameEvent )
{
	return 0;
}

DWORD UserFrame::OnGuildPageEvent( tagUserEvent* pGameEvent )
{
	return 0;
}

DWORD UserFrame::OnClearSafeCodeEvent(tagUserEvent* pGameEvent)
{
	return 0;
}

DWORD UserFrame::OnCloseGuardEvent(tagUserEvent* pGameEvent)
{
	return 0;
}
