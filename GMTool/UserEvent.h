...
//添加过滤词
struct tagAddFilterWords : public tagUserEvent
{
	DWORD		dwErrorCode;
	tagAddFilterWords(LPCTSTR szEventName) : tagUserEvent(szEventName)
	{
		dwErrorCode		= 0;
	}
};
...
//删除过滤词
struct tagDelFilterWords : public tagUserEvent
{
	DWORD		dwErrorCode;
	tagDelFilterWords(LPCTSTR szEventName) : tagUserEvent(szEventName)
	{
		dwErrorCode		= 0;
	}
};
...
//修改帮派据点战占领状态
struct tagGuildGodMiracle : public tagUserEvent
{
	DWORD		dwErrorCode;
	tagGuildGodMiracle(LPCTSTR szEventName) : tagUserEvent(szEventName)
	{
		dwErrorCode		= 0;
	}
};
...
//清空帐号安全码
struct tagClearSafeCode : public tagUserEvent
{
	DWORD		dwErrorCode;
	tagClearSafeCode(LPCTSTR szEventName) : tagUserEvent(szEventName)
	{
		dwErrorCode		= 0;
	}
};
...
//关闭防沉迷
struct tagCloseGuard : public tagUserEvent
{
	DWORD		dwErrorCode;
	tagCloseGuard(LPCTSTR szEventName) : tagUserEvent(szEventName)
	{
		dwErrorCode		= 0;
	}
};