...
public:
	...
	void OnClearSafeCode(wxCommandEvent& event);
	DWORD OnClearSafeCodeEvent(tagUserEvent* pGameEvent);
	void OnCloseGuard(wxCommandEvent& event);
	DWORD OnCloseGuardEvent(tagUserEvent* pGameEvent);
...
private:
	...
	wxButton*				m_btn_ClearSafeCode;
	wxTextCtrl*				m_text_SCAccountName;

	wxButton*				m_btn_CloseGuard;
	wxTextCtrl*				m_text_CGAccountName;
