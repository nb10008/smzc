...
public:
	...
	virtual DWORD OnSysMgrPageEvent( tagUserEvent* pGameEvent );
	virtual DWORD OnGuildPageEvent( tagUserEvent* pGameEvent );
	virtual DWORD OnClearSafeCodeEvent(tagUserEvent* pGameEvent);
	virtual DWORD OnCloseGuardEvent(tagUserEvent* pGameEvent);
